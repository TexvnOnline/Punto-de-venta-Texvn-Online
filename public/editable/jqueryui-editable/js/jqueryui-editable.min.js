...
function (a) {
    ...
    a.extend(a.fn.editableContainer.Popup.prototype, {
        ...
        defaults: a.ui.tooltip.prototype.options,
        splitOptions: function () {
...
function (a) {
    ...
    a.fn.editableutils.inherit(b, a.fn.editabletypes.abstractinput), a.extend(b.prototype, {
        ...
        activate: function () {},
        clear: function () {
            this.$input.datepicker("setDate", null), this.isAutosubmit && this.submit()
        },
        autosubmit: function () {
            this.isAutosubmit = !0, this.$input.on("mouseup", "table.ui-datepicker-calendar a.ui-state-default", a.proxy(this.submit, this))
        },
        submit: function () {
            var a = this.$input.closest("form");
            setTimeout(function () {
                a.submit()
            }, 200)
        }
