...
<!-- Mirrored from www.urbanui.com/melody/template/pages/maps/mapeal.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Sep 2018 06:08:50 GMT -->
<head>
  <!-- Required meta tags -->
  <meta charset="utf-8">
...
<body>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="maps">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="google-maps.html">Google Map</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
          ...
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Mapeal</li>
              </ol>
            </nav>
          </div>
          <div class="row">
  ...
  <script src="../../js/mapeal.js"></script>
  <script src="../../js/mapeal_example_1.js"></script>
  <script src="../../js/mapeal_example_2.js"></script>
  <!-- End custom js for this page-->
</body>


<!-- Mirrored from www.urbanui.com/melody/template/pages/maps/mapeal.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Sep 2018 06:08:51 GMT -->
</html>
