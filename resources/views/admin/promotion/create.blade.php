                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control date_time_picker" name="raw_start_date" id="start_date" value="{{old('start_date')}}" autocomplete="off" required>
                              </div>       
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="ending_date">Fecha final</label>
                                <input type="text" class="form-control date_time_picker" name="raw_ending_date" id="ending_date" value="{{old('ending_date')}}" autocomplete="off" required>
                              ...
                              <div class="col-sm-4">
                                <div class="form-check">
                                  <label class="form-check-label">
                                    ...
                                    @if (old('promotion_type') =='fixed_amount')
                                      checked
                                    @endif
                                    >
                                    Monto fijo
                        ...
                        <div class="col-md-4" id="div_fixed_amount_discount">
                            <div class="form-group">
                                <label for="fixed_amount_discount">Monto de descuento</label>
                                    ...
                                    <input type="number" class="form-control" name="fixed_amount_discount" id="fixed_amount_discount" value="{{old('fixed_amount_discount')}}"  step="0.01">
...
<script>
    ...
    $(document).ready(function(){
        ...
        var valor1 = $('#membershipRadios1').val();
        if(valor1 == 'percent'){
        ...
        var valor2 = $('#membershipRadios2').val();
        if(valor2 == 'fixed_amount'){
